var dashboard = document.querySelector("#dashboard"),
  ...
  startCameraStreaming = document.querySelector("#startCameraStreaming"),
  startFileStreaming = document.querySelector("#startFileStreaming"),
  receiveStreaming = document.querySelector("#receiveStreaming"),
...
startCameraStreaming.onclick = function () {
  // Trigger "start-streaming" event when the "Start Streaming from Camera" button is clicked
  socket.emit("start-streaming");
  dashboard.style.display = "none";
  stream.style.display = "block";
  isSource = true; // Set the user as the source
  handleFile(); // Display local video feed
};

startFileStreaming.onclick = function () {
  // Trigger "start-streaming" event when the "Start Streaming from File" button is clicked
  socket.emit("start-streaming");
  dashboard.style.display = "none";
  stream.style.display = "block";
  isSource = true; // Set the user as the source
...
receiveStreaming.onclick = function () {
